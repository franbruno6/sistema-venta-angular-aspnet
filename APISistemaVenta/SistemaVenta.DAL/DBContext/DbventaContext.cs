...
public partial class DbventaContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.IdCategoria).HasName("PK__Categori__8A3D240C1ABDF7FF");
        ...
        {
            entity.HasKey(e => e.IdDetalleVenta).HasName("PK__DetalleV__BFE2843F8571DEB1");
        ...
        {
            entity.HasKey(e => e.IdMenu).HasName("PK__Menu__C26AF483CAE874F8");
        ...
        {
            entity.HasKey(e => e.IdMenuRol).HasName("PK__MenuRol__9D6D61A4CB701C34");
        ...
        {
            entity.HasKey(e => e.IdNumeroDocumento).HasName("PK__NumeroDo__471E421A94BEB552");
        ...
        {
            entity.HasKey(e => e.IdProducto).HasName("PK__Producto__07F4A1327542FC0B");
        ...
        {
            entity.HasKey(e => e.IdRol).HasName("PK__Rol__3C872F76A96DA7C3");
        ...
        {
            entity.HasKey(e => e.IdUsuario).HasName("PK__Usuario__645723A60BC12B0B");
        ...
        {
            entity.HasKey(e => e.IdVenta).HasName("PK__Venta__077D5614ABB800B0");
